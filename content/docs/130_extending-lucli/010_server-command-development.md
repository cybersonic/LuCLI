...
<!-- TODO: This is now outdated, you should creatae your own classes to handle the commands. The terminal will also run them and there is no need to add them to UnifiedCommandExecutor  -->
