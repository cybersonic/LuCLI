                ...
                <article class="download-card">
                    ...
                    <div class="download-card-footer">
                        ...
                        <div class="install-command-block">
                            ...
                            <div class="install-command-row">
                                <code id="install-command-unix-pinned">LUCLI_VERSION=0.3.2 curl -LsSf https://lucli.dev/install.sh | sh</code>
                ...
                <article class="download-card">
                    ...
                    <div class="download-card-footer">
                        ...
                        <div class="install-command-block">
                            <p class="install-command-label">Pinned version example</p>
                            <div class="install-command-row">
                                <code id="install-command-win-pinned">powershell -ExecutionPolicy Bypass -NoProfile -Command "&amp; { $env:LUCLI_VERSION='0.3.2'; irm https://lucli.dev/install.ps1 | iex }"</code>
